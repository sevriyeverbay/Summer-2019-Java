...
public static void main(String[] args) {
	...
	// long:
		...
		// byte BByteum3 = LongNum;
		// short ShortNum5 = 100l;
	...
	// char: takes character  , char values MUST be declared within single quote.
			...
			// char ccharacter3 = 'AA';  only a single character can be declared. 
			...
			// float: 
				...
				// practices: 
				/*
				 * 8, 9, #, @, 8.5, 5.5F, 128, 40000, 9>8, true, false
				 */
